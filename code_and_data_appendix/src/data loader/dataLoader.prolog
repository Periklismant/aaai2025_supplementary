...
writeEvent(Row) :-
	...
	Row =.. [_RowAtom|[EventLabel|[_ArrivalTime|[OccurenceTime|EventAttributes]]]],
	Event =.. [EventLabel|EventAttributes],
	write("happensAt("), write(Event), write(","), write(OccurenceTime), write(")."), nl, !.
...
writeFluent(Row) :-
	...
	% points(Fluent=Value), !,
	points(Fluent=Value), !,
	write("holdsAt("), write(Fluent=Value), write(","), write(OccurenceTime), write(")."), nl.
...
writeFluent(Row) :-
	...
	Row =.. [_RowAtom|[FluentLabel|[_ArrivalTime|[StartOccurenceTime|[EndOccurenceTime|[Value|FluentAttributes]]]]]],
	Fluent =.. [FluentLabel|FluentAttributes],
	write("holdsFor("), write(Fluent=Value), write(",("), write(StartOccurenceTime), write(","), write(EndOccurenceTime), write("))."), nl, !.
